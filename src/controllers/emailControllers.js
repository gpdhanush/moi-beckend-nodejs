    ...
    forgotOtp: async (req, res) => {
        ...
        <div style="margin:0px;width:95%;padding:10px 0">
            <div style="border-bottom:1px solid #eee">
              <a href="#" style="font-size:1.4em;color: #00466a;text-decoration:none;font-weight:600">Moi Expense</a>
            </div>
            <p style="font-size:1.1em">Hi <span style="font-size:1.1em;font-weight: bold;color: #2c2c54;">${userName}</span>,</p>
            <p>Thank you for using Moi Expense. To complete the Forgot Password process, please use the following OTP. This OTP is valid for the next 2 minutes.</p>
            <h2 style="background: #00466a;margin: 0 auto;width: max-content;padding: 0 10px;color: #fff;border-radius: 4px;">${otp}</h2>
            <p style="font-size:0.9em;">Regards, <br />Moi Expense </p>
